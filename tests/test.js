...
describe('slush-react-express', function () {
    ...
    describe('Minimal generator', function () {
        beforeEach(function () {
            mock_1["default"]({ 'appname': 'Test Name', 'type': 'Minimal', 'createDir': false });
        });
    ...
    describe('Full generator', function () {
        beforeEach(function () {
            mock_1["default"]({ 'appname': 'Test Name', 'type': 'Full', 'ts': 'JavaScript', 'sass': 'CSS', 'createDir': false });
        });
        it('should put files in current working directory', function (done) {
            slushfile_1["default"](function () {
                mockGulpDest.cwd().should.equal(__dirname);
        ...
        describe('Sass', function () {
            beforeEach(function () {
                mock_1["default"]({ 'appname': 'Test Name', 'type': 'Full', 'ts': 'JavaScript', 'sass': 'SASS', 'createDir': false });
            });
        ...
        describe('TypeScript', function () {
            beforeEach(function () {
                mock_1["default"]({ 'appname': 'Test Name', 'type': 'Full', 'sass': 'CSS', 'ts': 'TypeScript', 'createDir': false });
            });
            it('should add the correct gulpfile to project root', function (done) {
                slushfile_1["default"](function () {
